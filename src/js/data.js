...
dataSource.products = {
  ...
  pizza: {
    ...
    images: [
      '<img class="active" src="images/pizza/crust.svg" alt="crust">',
      '<img class="sauce-tomato" src="images/pizza/tomato-sauce.svg" alt="tomato sauce">',
      '<img class="sauce-cream" src="images/pizza/sour-cream.svg" alt="sour cream">',
      '<img class="toppings-salami" src="images/pizza/salami.svg" alt="salami">',
      '<img class="toppings-olives" src="images/pizza/olives.svg" alt="olives">',
      '<img class="toppings-redPeppers" src="images/pizza/red-peppers.svg" alt="red peppers">',
      '<img class="toppings-greenPeppers" src="images/pizza/green-peppers.svg" alt="green peppers">',
      '<img class="toppings-mushrooms" src="images/pizza/mushrooms.svg" alt="mushrooms">',
      '<img class="toppings-basil" src="images/pizza/basil.svg" alt="basil">',
    ],
    params: {
      sauce: {
        label: 'Sauce',
  ...
  salad: {
    ...
    images: [
      ...
      '<img class="ingredients-cucumber" src="images/salad/cucumber.svg" style="z-index: 1;" alt="cucumber">',
      '<img class="ingredients-tomatoes" src="images/salad/tomatoes.svg" style="z-index: 2;" alt="tomatoes">',
      '<img class="ingredients-olives" src="images/salad/salad-olives.svg" style="z-index: 3;" alt="olives">',
      '<img class="ingredients-feta" src="images/salad/feta.svg" style="z-index: 4;" alt="feta">',
      '<img class="ingredients-herbs" src="images/salad/herbs.svg" style="z-index: 5;" alt="herbs">',
      '<img class="ingredients-cheese" src="images/salad/cheese.svg" style="z-index: 6;" alt="cheese">',
      '<img class="ingredients-pepper" src="images/salad/black-pepper.svg" style="z-index: 7;" alt="pepper">',
    ],
    params: {
      ingredients: {
        label: 'Ingredients',
